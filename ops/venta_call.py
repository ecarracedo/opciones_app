...
def calcular_venta_call (precio_strike, prima, cant_contratos=1, rango=40):
    ...
    for precio_sub in precios:
        resultado = (max(0, precio_sub - precio_strike) - prima) * cant_contratos * -1
    ...
    ax.axhline(y=prima * cant_contratos, color='g', linestyle='--', label='Ganancia máxima')

    # Texto de ganancia máxima en el gráfico
    ...
    ax.set_title('Resultado de una Venta de CALL', fontsize=16)  # Título del gráfico
